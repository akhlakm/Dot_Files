-- Toogle a terminal session similar to VScode at the bottom
...
vim.api.nvim_create_user_command("TermToggle", function()
	...
	-- Open new window 15 lines tall at the bottom of the screen
	vim.cmd("botright 15 new")
